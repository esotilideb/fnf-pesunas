...
class ShaderChroma extends FlxShader
{
     @:glFragmentSource('
    ...
    */
    ...
    void main( vec4 fragColor, vec2 fragCoord )
    {
        ...
        float GLITCH = 0.1 + iResolution.x;
        ...
        for( int i=0; i<NUM_SAMPLES; ++i )
        {
            ...
            uv.x = sat( uv.x + ofs * t );
            vec4 samplecol =  flixel_texture2D( bitmap, uv, -10.0 );
