...
zoomextra = 0.2; --Coloca con cuanto zoom extra quieres que inicie la cancion, el predeterminado de extra es 0 (solo el que tiene el stage)
...
atrasnegro = false; -- Activa o desactiva un fondo negro por detras de los personajes
opacidadfondo = 1 -- si activas ATRASNEGRO 

dadx1 = -20; --Eje X de camara de dad (Menos = Izquierda  Mas = Derecha)
dady1 = 60; --Eje Y de camara de dad (Menos = Arriba  Mas = Abajo)
bfx1 = 70; --Eje X de camara de bf (Menos = Izquierda  Mas = Derecha)
bfy1 = 15; --Eje Y de camara de bf (Menos = Arriba  Mas = Abajo)
gfx1 = -10; --Eje X de camara de gf (Menos = Izquierda  Mas = Derecha) Recomiendo usarlo para otra posicion de camara extra si gf no canta
gfy1 = 140; --Eje Y de camara de gf (Menos = Arriba  Mas = Abajo) Recomiendo usarlo para otra posicion de camara extra si gf no canta
centrox1 = 0;
centroy1 = 0;
...
if usarcam == true then
    ...
    bfx = getMidpointX('boyfriend') + (getProperty('boyfriend.cameraPosition[0]') - getProperty('boyfriendCameraOffset[0]')) - 175 + bfx1
